...
class NotPredicateSpec extends ObjectBehavior
{
    ...
    function it_should_succeed_if_the_sub_expression_fails_but_not_consume_anything(TokenIterator $iterator, Parser $first)
    {
    ...
    function it_should_fail_if_the_sub_expression_succeeds(TokenIterator $iterator, Parser $first)
    {
